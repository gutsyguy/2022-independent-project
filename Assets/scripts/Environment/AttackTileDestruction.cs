...
public class AttackTileDestruction : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        attackCheck = playerMovement.AttackCheck;
    }
    ...
    void Update()
    {
        ...
        attackPos = Camera.main.ScreenToWorldPoint(attackCheck.position);
        tilePos = grid.WorldToCell(attackPos);
